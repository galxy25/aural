...
MAINTAINER Levi Schoen <levismschoen@gmail.com>
...
ENV INSTALL_PATH /aural
# The name of the application is aural and while there
...
# having to CD into the /aural folder every time would be
# lame, so instead we can set the WORKDIR to be /aural.
#
...
# aural/ path inside of the Docker image.
#
# It copies it to /aural because of the WORKDIR being set.
#
...
# /aural folder inside of the Docker image.
#
